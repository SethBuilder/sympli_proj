...
urlpatterns=[
	...
	url(r'^ثقافه_و_فن/$', views.culture, name='culture'),
	url(r'^رياضه/$', views.sport, name='sport'),
	url(r'^منوعات/$', views.variety, name='variety'),
	url(r'^(?P<category>أخبار_العالم|^$|علوم_و_تكنولوجيا|صحه|ترند|سياحه_و_سفر|ثقافه_و_فن|رياضه|منوعات)/(?P<article_id>[\w\-]+)/', views.show_article, name="show_article"),
